...
class SilverGoblinScraper(Scraper):
    ...
    def scrape(self, proxy):
        ...
        response = requests.post(self.url, 
            json={
                "storeUrl":"silver-goblin.myshopify.com",
                "game":"mtg",
                "strict":None,
            ...
            headers={
                ...
                'origin': 'https://silvergoblin.cards',
                'pragma': 'no-cache',
                'referer': 'https://silvergoblin.cards/',
