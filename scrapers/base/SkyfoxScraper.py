...
class SkyfoxScraper(Scraper):
    """
    Skyfox can be scraped by hitting their API.

    Split cards can be searched using "//" as a split
    """
    def __init__(self, cardName):
        Scraper.__init__(self, cardName)
        self.siteUrl = 'https://skyfoxgames.com'
    ...
    def scrape(self, proxy):
        ...
        response = requests.post(self.url, proxies=proxies,
            json={
                "storeUrl":"sky-fox-games.myshopify.com",
                "game":"mtg",
                "strict":None,
