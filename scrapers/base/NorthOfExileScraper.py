...
class NorthOfExileScraper(Scraper):
    ...
    def scrape(self):
        ...
        response = requests.post(self.url, 
            json={
                "storeUrl":"north-of-exile-games.myshopify.com",
                "game":"mtg",
                "strict":None,
            ...
            headers={
                ...
                'origin': 'https://NorthOfExilegames.com',
                'pragma': 'no-cache',
                'referer': 'https://NorthOfExilegames.com/',
