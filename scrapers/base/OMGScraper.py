...
class OMGScraper(Scraper):
    """
    Identical to MythicStore
    OMG can be scraped by hitting their API.

    Split cards can be searched using "//" as a split
    """
    def __init__(self, cardName):
        Scraper.__init__(self, cardName)
        self.siteUrl = 'https://www.omggames.ca'
    ...
    def scrape(self, proxy):
        ...
        response = requests.post(self.url, proxies=proxies,
            json={
                "storeUrl":"omg-games-on.myshopify.com",
                "game":"mtg",
                "strict":None,
            ...
            headers={
                ...
                'origin': 'https://omggames.ca',
                'pragma': 'no-cache',
                'referer': 'https://omggames.ca/',
