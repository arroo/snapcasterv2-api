...
class PandorasBooxScraper(Scraper):
    """
    PandorasBoox can be scraped by hitting their API.
    ...
    def scrape(self, proxy):
        ...
        response = requests.post(self.url, proxies=proxies,
            json={
                "storeUrl":"pandoras-boox.myshopify.com",
                "game":"mtg",
                "strict":None,
            ...
            headers={
                ...
                'origin': 'https://pandorasboox.ca',
                'pragma': 'no-cache',
                'referer': 'https://pandorasboox.ca/',
