...
class KesselRunScraper(Scraper):
    """
    Identical to MythicStore
    KesselRun can be scraped by hitting their API.
    ...
    def scrape(self):
        ...
        response = requests.post(self.url, 
            json={
                "storeUrl":"kessel-run-games.myshopify.com",
                "game":"mtg",
                "strict":None,
            ...
            headers={
                ...
                'origin': 'https://kesselrungames.ca',
                'pragma': 'no-cache',
                'referer': 'https://kesselrungames.ca/',
