...
class FantasyForgedScraper(Scraper):
    ...
    FantasyForged can be scraped by hitting their API.

    Split cards can be searched using "//" as a split
    """
    def __init__(self, cardName):
        Scraper.__init__(self, cardName)
        self.siteUrl = 'https://www.FantasyForged.ca'
    ...
    def scrape(self, proxy):
        ...
        response = requests.post(self.url, 
            json={
                "storeUrl":"fantasy-forged.myshopify.com",
                "game":"mtg",
                "strict":None,
            ...
            headers={
                ...
                'origin': 'https://fantasyforged.ca',
                'pragma': 'no-cache',
                'referer': 'https://fantasyforged.ca/',
