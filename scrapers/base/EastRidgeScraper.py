...
class EastRidgeScraper(Scraper):
    ...
    def scrape(self, proxy):
        ...
        response = requests.post(self.url, proxies=proxies,
            json={
                "storeUrl":"eastridge-sport-cards-games.myshopify.com",
                "game":"mtg",
                "strict":None,
            ...
            headers={
                ...
                'origin': 'https://ergames.ca',
                'pragma': 'no-cache',
                'referer': 'https://ergames.ca/',
