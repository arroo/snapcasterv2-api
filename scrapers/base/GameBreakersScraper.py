...
class GameBreakersScraper(Scraper):
    """
    Identical to House of Cards
    Just plain old search, no API
    """
    def __init__(self, cardName):
        Scraper.__init__(self, cardName)
        self.baseUrl = 'https://gamebreakers.ca'
        self.searchUrl = self.baseUrl + '/search?page=1&q=%2A'
        self.url = self.createUrl()
        self.website='gamebreakers'
