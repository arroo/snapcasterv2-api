...
class WaypointScraper(Scraper):
    ...
    def scrape(self, proxy):
        ...
        response = requests.post(self.url, proxies=proxies,
            json={
                "storeUrl":"waypoint-games-ca.myshopify.com",
                "game":"mtg",
                "strict":None,
            ...
            headers={
                ...
                'origin': 'https://waypointgames.ca',
                'pragma': 'no-cache',
                'referer': 'https://waypointgames.ca/',
