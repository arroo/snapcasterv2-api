...
class VortexGamesScraper(Scraper):
    """
    Identical to MythicStore
    VortexGames can be scraped by hitting their API.
    ...
    def scrape(self, proxy):
        ...
        response = requests.post(self.url, proxies=proxies,
            json={
                "storeUrl":"vortex-games-nb.myshopify.com",
                "game":"mtg",
                "strict":None,
            ...
            headers={
                ...
                'origin': 'https://vortexgames.ca',
                'pragma': 'no-cache',
                'referer': 'https://vortexgames.ca/',
