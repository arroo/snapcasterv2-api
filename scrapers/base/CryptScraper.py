...
class CryptScraper(Scraper):
    """
    Identical to MythicStore
    Crypt can be scraped by hitting their API.

    Split cards can be searched using "//" as a split
    """
    def __init__(self, cardName):
        Scraper.__init__(self, cardName)
        self.siteUrl = 'https://www.cryptmtg.com'
    ...
    def scrape(self, proxy):
        ...
        response = requests.post(self.url, 
            json={
                "storeUrl":"la-crypte-ca.myshopify.com",
                "game":"mtg",
                "strict":None,
            ...
            headers={
                ...
                'origin': 'https://cryptmtg.com',
                'pragma': 'no-cache',
                'referer': 'https://cryptmtg.com/',
