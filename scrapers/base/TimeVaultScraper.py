...
class TimeVaultScraper(Scraper):
    """
    TimeVault can be scraped by hitting their API.

    Split cards can be searched using "//" as a split
    """
    def __init__(self, cardName):
        Scraper.__init__(self, cardName)
        self.siteUrl = 'https://thetimevault.ca'
        self.url = "https://portal.binderpos.com/external/shopify/products/forStore"
        self.website = 'timevault'
    ...
    def scrape(self):
        ...
        response = requests.post(self.url, 
            json={
                "storeUrl":"the-time-vault-ca.myshopify.com",
                "game":"mtg",
                "strict":None,
            ...
            headers={
                ...
                'origin': 'https://thetimevault.ca',
                'pragma': 'no-cache',
                'referer': 'https://thetimevault.ca/',
