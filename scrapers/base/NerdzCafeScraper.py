...
class NerdzCafeScraper(Scraper):
    ...
    def scrape(self, proxy):
        ...
        response = requests.post(self.url, proxies=proxies,
            json={
                "storeUrl":"nerdz-cafe.myshopify.com",
                "game":"mtg",
                "strict":None,
            ...
            headers={
                ...
                'origin': 'https://nerdzcafe.com',
                'pragma': 'no-cache',
                'referer': 'https://nerdzcafe.com/',
