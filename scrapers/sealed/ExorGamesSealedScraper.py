...
class ExorGamesSealedScraper(SealedScraper):
    """
    ...
    1. https://ExorGamesgames.com/collections/sealed-magic?filter.v.availability=1
    2. https://ExorGamesgames.com/collections/sealed-magic?filter.v.availability=1&page=2
    3. https://ExorGamesgames.com/collections/sealed-magic?filter.v.availability=1&page=3
    ...
    Same as chimera, everthing, etc
    """

    def __init__(self, setName):
        SealedScraper.__init__(self, setName)
        self.baseUrl = 'https://ExorGames.com'
    ...
    def scrape(self):
        ...
        try:
            ...
            try:
                ...
                cur.execute("SELECT * FROM sealed_prices WHERE website = 'exorgames' AND updated_at > NOW() - INTERVAL '8 hours'")
                rows = cur.fetchall()
            except:
                conn.rollback()
                rows = []
