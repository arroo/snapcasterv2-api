...
class SequenceSealedScraper(SealedScraper):
    """
...
"""
    ...
    def scrape(self):
        ...
        try:
            ...
            if len(rows) > 0:
                print("Using cached data for Sequence")
            ...
            # otherwise, scrape the site and update the database
                ...
                while nextPage is not None:
                    page = requests.get('https://www.sequencecomics.ca'+ nextPage['href'])
                    sp = BeautifulSoup(page.text, 'html.parser')
                ...
                for product in allProducts:
                    link = 'https://www.sequencecomics.ca' + product.select_one('div.image a')['href']
            ...
            conn.close()
            print("SequenceSealedScraper: Error on line {}".format(sys.exc_info()[-1].tb_lineno), type(e).__name__, e)