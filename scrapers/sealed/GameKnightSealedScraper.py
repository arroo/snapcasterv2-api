...
class GameKnightSealedScraper(SealedScraper):
    """
    ...
    1. https://gameknight.ca/collections/mtg-boosters?page=4
    ...
    def __init__(self, setName):
        ...
        self.baseUrl = 'https://gameknight.ca'
    ...
    def scrape(self):
        ...
        try:
            ...
            try:
                ...
                cur.execute("SELECT * FROM sealed_prices WHERE website = 'gameknight' AND updated_at > NOW() - INTERVAL '8 hours'")
                rows = cur.fetchall()
            except:
                conn.rollback()
                rows = []
            ...
            # otherwise, scrape the site and update the database
                ...
                curPage = 1
                boosterPackUrl = self.baseUrl + '/collections/mtg-boosters?page=' + str(curPage)
...
def main():
    scraper = GameKnightSealedScraper('Dominaria')
    scraper.scrape()
