...
class EnterTheBattlefieldSealedScraper(SealedScraper):
    """
    ...
    1. https://enterthebattlefield.ca/collections/magic-sealed-products?filter.v.availability=1
    2. https://enterthebattlefield.ca/collections/magic-sealed-products?filter.v.availability=1&page=2
    3. https://enterthebattlefield.ca/collections/magic-sealed-products?filter.v.availability=1&page=3
    ...
    def __init__(self, setName):
        ...
        self.baseUrl = 'https://enterthebattlefield.ca'
    ...
    def scrape(self):
        # We want to check the database for enterthebattlefield data, if it has been updated in the last 8 hours, return the data
        ...
        try:
            ...
            try:
                ...
                cur.execute("SELECT * FROM sealed_prices WHERE website = 'enterthebattlefield' AND updated_at > NOW() - INTERVAL '8 hours'")
                rows = cur.fetchall()
            except:
                conn.rollback()
                rows = []
            ...
            # otherwise, scrape the site and update the database
                ...
                curPage = 1
                # print('https://enterthebattlefield.ca/collections/magic-sealed-products?filter.v.availability=1&page=1')
                url = self.baseUrl + '/collections/mtg-sealed/?page=' + str(curPage)
                ...
                for product in allProducts:
                    i+=1
                    try:
                        stock = product.findAll('option')
                        for option in stock:
                            if option.text == 'Sold Out':
                                continue
            ...
            print("EnterTheBattleFieldSealedScraper: Error on line {}".format(sys.exc_info()[-1].tb_lineno), type(e).__name__, e)
