...
class HairyTScraper(Scraper):
    ...
    def scrape(self):
        ...
        return
        assert self.response is not None, "Response is None in HairyTScraper"
        # data = json.loads(self.response)
        data = self.response # already decodewd json
